...
{
    public partial class encuestas_11 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_encuesta_general_Clientes_Clientesid",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_encuesta_queja_Clientes_Clientesid",
                        column: x => x.Clientesid,
                        principalTable: "Clientes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_encuesta_general_Clientesid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_encuesta_queja_Clientesid",
