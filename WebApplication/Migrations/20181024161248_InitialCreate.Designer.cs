...
namespace WebApplication.Migrations
{
    ...
    [Migration("20181024161248_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication.Models.Cat_Productos_Respuestas_Troubleshooting", b =>
                {
                    ...
                    b.Property<int>("id_troubleshooting");

                    b.Property<string>("solucion");

                    b.HasKey("id");

                    b.HasIndex("id_troubleshooting");
            ...
            modelBuilder.Entity("WebApplication.Models.Cat_SubLinea_Producto", b =>
                {
                    ...
                    b.Property<int?>("id_lineaid");

                    b.HasKey("id");

                    b.HasIndex("id_lineaid");
            ...
            modelBuilder.Entity("WebApplication.Models.Check_List_Categoria_Producto", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("categoria_en");

                    b.Property<string>("sku");

                    b.HasKey("id");

                    b.ToTable("Check_List_Categoria_Producto");
                });
            ...
            modelBuilder.Entity("WebApplication.Models.condiones_comerciales_sucursal", b =>
                {
                    ...
                    b.Property<int?>("Cat_SubLinea_Productoid");

                    b.Property<int?>("Cat_SucursalesId");
                    ...
                    b.HasIndex("Cat_SubLinea_Productoid");

                    b.HasIndex("Cat_SucursalesId");
            ...
            modelBuilder.Entity("WebApplication.Models.Cat_Linea_Producto", b =>
                {
                    b.HasOne("WebApplication.Models.Cat_Categoria_Producto", "id_categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication.Models.Cat_Productos", b =>
                {
                    b.HasOne("WebApplication.Models.Cat_Categoria_Producto", "categoria")
                        .WithMany("productos")
                        .HasForeignKey("id_categoria")
                        .HasConstraintName("ForeignKey_Categoria_Producto")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("WebApplication.Models.Cat_Productos_Respuestas_Troubleshooting", b =>
                {
                    b.HasOne("WebApplication.Models.Cat_Productos_Preguntas_Troubleshooting", "troubleshooting")
                        .WithMany("cat_Productos_respuestas_troubleshooting")
                        .HasForeignKey("id_troubleshooting")
            ...
            modelBuilder.Entity("WebApplication.Models.Cat_SubLinea_Producto", b =>
                {
                    b.HasOne("WebApplication.Models.Cat_Linea_Producto", "id_linea")
                        .WithMany()
                        .HasForeignKey("id_lineaid");
                });
            ...
            modelBuilder.Entity("WebApplication.Models.Check_List_Preguntas", b =>
                {
                    b.HasOne("WebApplication.Models.Check_List_Categoria_Producto", "categoria")
                        .WithMany("Preguntas")
                        .HasForeignKey("id_categoria")
            ...
            modelBuilder.Entity("WebApplication.Models.condiones_comerciales_sucursal", b =>
                {
                    b.HasOne("WebApplication.Models.Cat_SubLinea_Producto", "Cat_SubLinea_Producto")
                        .WithMany()
                        .HasForeignKey("Cat_SubLinea_Productoid");

                    b.HasOne("WebApplication.Models.Cat_Sucursales", "Cat_Sucursales")
                        .WithMany()
                        .HasForeignKey("Cat_SucursalesId");
                });
            ...
            modelBuilder.Entity("WebApplication.Models.Producto_Promocion", b =>
                {
                    b.HasOne("WebApplication.Models.Cat_Producto", "Cat_Producto")
            ...
            modelBuilder.Entity("WebApplication.Models.Tecnicos_Producto", b =>
                {
                    b.HasOne("WebApplication.Models.Cat_Categoria_Producto", "producto")
