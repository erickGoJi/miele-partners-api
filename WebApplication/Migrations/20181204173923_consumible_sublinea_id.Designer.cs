...
namespace WebApplication.Migrations
{
    ...
    [Migration("20181204173923_consumible_sublinea_id")]
    partial class consumible_sublinea_id
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication.Models.Cer_accesorios", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebApplication.Models.Cer_producto_cliente", b =>
                {
                    ...
                    b.Property<int?>("Cer_accesoriosid");
            ...
            modelBuilder.Entity("WebApplication.Models.Cer_producto_cliente", b =>
                {
                    b.HasOne("WebApplication.Models.Cer_accesorios")
                        .WithMany("cer_producto_cliente")
                        .HasForeignKey("Cer_accesoriosid");

                    b.HasOne("WebApplication.Models.Clientes", "clientes")
                        .WithMany("cer_producto_cliente")
                        .HasForeignKey("id_cliente")
                    ...
                    b.HasOne("WebApplication.Models.Cat_Productos", "producto")
                        .WithMany("cer_producto_cliente")
                        .HasForeignKey("id_producto")
                        .HasConstraintName("ForeignKey_Producto_Mantenimiento")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("WebApplication.Models.rel_consumible_sublinea", b =>
                {
                    b.HasOne("WebApplication.Models.Cer_consumibles", "consumible")
                        ...
                        .HasForeignKey("id_consumible")
                        .HasConstraintName("ForeignKey_Consumible_sublinea")
                        .OnDelete(DeleteBehavior.Cascade);
                });
