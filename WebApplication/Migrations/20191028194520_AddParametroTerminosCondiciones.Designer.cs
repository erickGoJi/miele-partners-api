...
namespace WebApplication.Migrations
{
    ...
    [Migration("20191028194520_AddParametroTerminosCondiciones")]
    partial class AddParametroTerminosCondiciones
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication.Models.config_comision", b =>
                {
                    ...
                    b.Property<bool>("aplica_comision");
                    ...
                    b.Property<decimal>("monto_superior");
            ...
            modelBuilder.Entity("WebApplication.Models.Parametro_Archivo_Terminos_Condiciones", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("parametro_Terminos_Condiciones");
                });
            ...
            modelBuilder.Entity("WebApplication.Models.rel_homep_producto", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebApplication.Models.Visita", b =>
                {
                    ...
                    b.Property<string>("motiva_cancelación");
                    ...
                    b.Property<string>("succes_pago");

                    b.Property<bool>("terminos_condiciones");

                    b.Property<string>("url_pdf_checklist");

                    b.Property<string>("url_pdf_cotizacion");
            ...
            modelBuilder.Entity("WebApplication.Models.comision_promo_sublinea_config", b =>
                {
                    b.HasOne("WebApplication.Models.condiones_comerciales_sucursal", "condiciones_promos")
                        .WithMany("comision_Promos")
                        .HasForeignKey("id_cc_sucursal")
                        .HasConstraintName("ForeignKey_comisiones_sublinea_config_cc_suc")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WebApplication.Models.promocion", "Promocion")
                        .WithMany("Comisiones_promociones")
                        .HasForeignKey("id_promocion")
            ...
            modelBuilder.Entity("WebApplication.Models.rel_homep_producto", b =>
                {
                    b.HasOne("WebApplication.Models.Home_producto_cliente", "homep")
                        .WithMany("homep_Productos")
                        .HasForeignKey("id_homep")
